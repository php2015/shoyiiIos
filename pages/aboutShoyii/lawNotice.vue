<template>
	<view class="" style="padding: 0 20rpx;text-indent: 4rpx;">
		<view class="" style="text-align: center;padding: 30rpx 0;">
			<text style="color: #000000;font-size: 36rpx;font-weight: bold;">法律声明</text>
		</view>
		<view class="" style="text-indent: 28px;padding: 10rpx 0;">
			<text>我们重视用户的隐私。您在使用我们的服务时，我们可能会收集和使用您的相关信息。我们希望通过本《隐私政策》向您说明，在使用我们的服务时，我们如何收集、使用、储存和分享这些信息，以及我们为您提供的访问、更新、控制和保护这些信息的方式。本《隐私政策》与您所使用的服务息息相关，希望您仔细阅读，在需要时，按照本《隐私政策》的指引，作出您认为适当的选择。本《隐私政策》中涉及的相关技术词汇，我们尽量以简明扼要的表述，并提供进一步说明的链接，以便您的理解。
您使用或继续使用我们的服务，即意味着同意我们按照本《隐私政策》收集、使用、储存和分享您的相关信息。</text></br>
		</view>
		<view class="" style="text-indent: 28px;padding: 10rpx 0;">
			<text>如对本《隐私政策》或相关事宜有任何问题，请通过https://www.shoyii.com与我们联系。</text>
		</view>
		<view class="" style="text-indent: 28px;padding: 10rpx 0;">
			<text>我们提供服务时，可能会收集、储存和使用下列与您有关的信息。如果您不提供相关信息，可能无法享受我们提供的某些服务，或者无法达到相关服务拟达到的效果。
您在使用我们的服务时，向我们提供的相关个人信息，例如电话号码、电子邮件或银行卡号等；
   您通过我们的服务向其他方提供的共享信息，以及您使用我们的服务时所储存的信息。其他方使用我们的服务时所提供有关您的共享信息。
您使用服务时我们可能收集如下信息：</text>
		</view>
		<view class="" style="text-indent: 28px;padding: 10rpx 0;">
			<text>日志信息，指您使用我们的服务时，系统可能通过cookies、web beacon或其他方式自动采集的技术信息，包括：设备或软件信息，例如您的移动设备、网页浏览器或用于接入我们服务的其他程序所提供的配置信息、您的IP地址和移动设备所用的版本和设备识别码；
...
通过在我们服务中进行广告服务的其他公司或机构所收集的信息。</text>
		</view>
		<view class=""  style="text-indent: 28px;padding: 10rpx 0;">
			<text style="color: #000000;font-size: 30rpx;font-weight: bold;">变更</text></br>
			<text>我们可能适时修订本《隐私政策》的条款，该等修订构成本《隐私政策》的一部分。如该等修订造成您在本《隐私政策》下权利的实质减少，我们将在修订生效前通过在主页上显著位置提示或向您发送电子邮件或以其他方式通知您。在该种情况下，若您继续使用我们的服务，即表示同意受本《隐私政策》的约束。
</text>
		</view>
